...
data class ExpenseCategoryTotal(val name: String, val amount: BigDecimal, val percentage: Int)
data class ExpensesData(
    val tripId: String? = null, val tripName: String = "", val availableTrips: List<Trip> = emptyList(),
    val totalSpent: BigDecimal = BigDecimal.ZERO, val categories: List<ExpenseCategoryTotal> = emptyList(),
    ...
    val totalBudget: BigDecimal? = null, val tripStatusText: String? = null, val currentUserId: String? = null,
