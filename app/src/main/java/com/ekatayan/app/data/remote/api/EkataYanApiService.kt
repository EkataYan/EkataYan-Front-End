...
interface EkataYanApiService {
    ...
    @GET("api/trips/{id}/expense-balances") suspend fun expenseBalances(@Path("id") id: String): ApiEnvelope<ExpenseBalancesDto>
    @PUT("api/expenses/{id}") suspend fun updateExpense(@Path("id") id: String, @Body body: ExpenseUpdateRequest): ApiEnvelope<ExpenseDto>
