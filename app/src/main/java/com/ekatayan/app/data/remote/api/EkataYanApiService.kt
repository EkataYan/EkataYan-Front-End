...
data class ItineraryActivityDto(val title: String, val location: String, @SerializedName("suggested_time") val suggestedTime: String, val description: String, @SerializedName("estimated_cost") val estimatedCost: String, val transport: String, val notes: String = "")
