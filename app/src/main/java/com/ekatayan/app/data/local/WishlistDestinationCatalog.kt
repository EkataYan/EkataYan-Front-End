...
object WishlistDestinationCatalog {
    val destinations = listOf(
        WishlistItem(1, "Sigiriya", "An ancient rock fortress rising above Sri Lanka's central plains.", "Matale District, Sri Lanka", R.drawable.sigiriya),
        ...
        WishlistItem(11, "Nine Arch Bridge", "An iconic stone railway bridge framed by Ella's lush jungle.", "Ella, Uva Province, Sri Lanka", R.drawable.nine_arch_bridge),
        WishlistItem(12, "Kandy", "Sri Lanka's cultural capital, set beside a scenic lake.", "Central Province, Sri Lanka", R.drawable.kandy),
        ...
        WishlistItem(14, "Polonnaruwa", "Remarkable ruins and monuments from Sri Lanka's medieval capital.", "North Central Province, Sri Lanka", R.drawable.polonnaruwa),
        WishlistItem(15, "Galle", "A vibrant southern city where heritage meets the Indian Ocean.", "Southern Province, Sri Lanka", R.drawable.galle),
